...
- Link each claim's provenance to a record in `wiki/sources/` using a relative Markdown link, e.g. `[source: micrograd](../sources/micrograd.md)`. Do not cite external URLs directly.
