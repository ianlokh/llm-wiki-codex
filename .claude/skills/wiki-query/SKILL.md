...
3. Attach a local citation to every factual statement in the form `wiki/concepts/file.md#Heading`, `wiki/entities/file.md#Heading`, or `wiki/sources/file.md#Heading`.
